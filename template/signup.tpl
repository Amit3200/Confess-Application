...
<input type="text" class="form-control-sm pick" placeholder="Enter Name" name="sname" required><br><br>
<input type="email" class="form-control-sm pick" placeholder="Enter email" name="semail" required><br><br>
<input type="Password" class="form-control-sm pick" placeholder="Enter Password" name="spass" required><br><br>
<button type="submit" class="btn btn-default io waves-effect waves-light w3-animate-top">Sign Up</button>
		</form>
<a href="\shift2">Already have an account?Login Here!</a><br><br>
